...
def log_normal_log_posterior_predictive(const double[::1] x,
                                    const double[::1] X, double l0_min,
                                    double l0_max, double l1_min,
                                    double l1_max):
    """
    Compute the logarithm of the posterior.
    """
    ...
    with nogil:
        LogNormalPosterior.log_posterior_predictive(M, &x[0], &log_post_pred[0],
                                              N, &X[0], l0_min, l0_max, l1_min,
                                              l1_max)
